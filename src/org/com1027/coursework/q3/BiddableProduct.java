...
public class BiddableProduct extends Product {
  ...
  /**
   * Constructor to create a BiddableProduct object.
   * @param productId
   * @param productName
   * @param reservedPrice
   */
  ...
  /**
   * Will attempt to bid on a product.
   * @param user
   * @param bidValue
   * @return purchase
   */
  ...
  /**
   * Will display the history of the product
   */
  @Override
  ...
  /**
   * will display the user information for a product.
   */
  @Override
  ...
  /**
   * Will get the last bid for a product.
   * @return currentPrice
   */
  @Override
